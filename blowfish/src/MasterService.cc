...
uint32_t MasterService_RepairHost_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t MasterService_RepairHost_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("MasterService_RepairHost_args");
...
uint32_t MasterService_RepairHost_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("MasterService_RepairHost_pargs");
...
uint32_t MasterService_RepairHost_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t MasterService_RepairHost_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("MasterService_RepairHost_result");
...
uint32_t MasterService_RepairHost_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
int64_t MasterServiceClient::RepairHost(const int32_t host_id, const int32_t mode)
{
  send_RepairHost(host_id, mode);
  return recv_RepairHost();
}

void MasterServiceClient::send_RepairHost(const int32_t host_id, const int32_t mode)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("RepairHost", ::apache::thrift::protocol::T_CALL, cseqid);

  MasterService_RepairHost_pargs args;
...
int64_t MasterServiceClient::recv_RepairHost()
{
  ...
  if (fname.compare("RepairHost") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  int64_t _return;
  MasterService_RepairHost_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "RepairHost failed: unknown result");
}
...
void MasterServiceProcessor::process_RepairHost(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("MasterService.RepairHost", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "MasterService.RepairHost");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "MasterService.RepairHost");
  }

  MasterService_RepairHost_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "MasterService.RepairHost", bytes);
  }

  MasterService_RepairHost_result result;
  try {
    result.success = iface_->RepairHost(args.host_id, args.mode);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "MasterService.RepairHost");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("RepairHost", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "MasterService.RepairHost");
  }

  oprot->writeMessageBegin("RepairHost", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "MasterService.RepairHost", bytes);
  }
}
