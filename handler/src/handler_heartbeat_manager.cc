...
HandlerHeartbeatManager::HandlerHeartbeatManager()
    : HeartbeatManager() {
  host_id_ = 0;
  client_info_.client = NULL;
}

HandlerHeartbeatManager::HandlerHeartbeatManager(int32_t host_id,
...
void HandlerHeartbeatManager::ConnectToMaster() {
  ...
  client_info_.client = new MasterClient(protocol);
...
void HandlerHeartbeatManager::PeriodicallyPing() {
...
void HandlerHeartbeatManager::Start() {
