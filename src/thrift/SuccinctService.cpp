...
uint32_t SuccinctService_get_all_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t SuccinctService_get_all_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("SuccinctService_get_all_args");
...
uint32_t SuccinctService_get_all_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("SuccinctService_get_all_pargs");
...
uint32_t SuccinctService_get_all_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t SuccinctService_get_all_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("SuccinctService_get_all_result");
...
uint32_t SuccinctService_get_all_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t SuccinctService_reconstruct_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t SuccinctService_reconstruct_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("SuccinctService_reconstruct_args");
...
uint32_t SuccinctService_reconstruct_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("SuccinctService_reconstruct_pargs");
...
uint32_t SuccinctService_reconstruct_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t SuccinctService_reconstruct_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("SuccinctService_reconstruct_result");
...
uint32_t SuccinctService_reconstruct_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void SuccinctServiceClient::get_all(std::string& _return, const int64_t key)
{
  send_get_all(key);
  recv_get_all(_return);
}

void SuccinctServiceClient::send_get_all(const int64_t key)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("get_all", ::apache::thrift::protocol::T_CALL, cseqid);

  SuccinctService_get_all_pargs args;
  args.key = &key;
  args.write(oprot_);
...
void SuccinctServiceClient::recv_get_all(std::string& _return)
{
  ...
  if (fname.compare("get_all") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  SuccinctService_get_all_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "get_all failed: unknown result");
}

void SuccinctServiceClient::reconstruct(std::string& _return)
{
  send_reconstruct();
  recv_reconstruct(_return);
}

void SuccinctServiceClient::send_reconstruct()
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("reconstruct", ::apache::thrift::protocol::T_CALL, cseqid);

  SuccinctService_reconstruct_pargs args;
  args.write(oprot_);
...
void SuccinctServiceClient::recv_reconstruct(std::string& _return)
{
  ...
  SuccinctService_reconstruct_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "reconstruct failed: unknown result");
}
...
void SuccinctServiceProcessor::process_get_all(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("SuccinctService.get_all", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "SuccinctService.get_all");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "SuccinctService.get_all");
  }

  SuccinctService_get_all_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "SuccinctService.get_all", bytes);
  }

  SuccinctService_get_all_result result;
  try {
    iface_->get_all(result.success, args.key);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "SuccinctService.get_all");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("get_all", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "SuccinctService.get_all");
  }

  oprot->writeMessageBegin("get_all", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "SuccinctService.get_all", bytes);
  }
}

void SuccinctServiceProcessor::process_reconstruct(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("SuccinctService.reconstruct", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "SuccinctService.reconstruct");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "SuccinctService.reconstruct");
  }

  SuccinctService_reconstruct_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "SuccinctService.reconstruct", bytes);
  }

  SuccinctService_reconstruct_result result;
  try {
    iface_->reconstruct(result.success);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "SuccinctService.reconstruct");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "SuccinctService.reconstruct");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "SuccinctService.reconstruct", bytes);
  }
}
