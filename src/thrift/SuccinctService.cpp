...
uint32_t SuccinctService_fetch_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t SuccinctService_fetch_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("SuccinctService_fetch_args");
...
uint32_t SuccinctService_fetch_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("SuccinctService_fetch_pargs");
...
uint32_t SuccinctService_fetch_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t SuccinctService_fetch_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("SuccinctService_fetch_result");
...
uint32_t SuccinctService_fetch_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void SuccinctServiceClient::fetch(std::string& _return, const int32_t qserver_id, const int64_t offset, const int32_t len)
{
  send_fetch(qserver_id, offset, len);
  recv_fetch(_return);
}

void SuccinctServiceClient::send_fetch(const int32_t qserver_id, const int64_t offset, const int32_t len)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("fetch", ::apache::thrift::protocol::T_CALL, cseqid);

  SuccinctService_fetch_pargs args;
  args.qserver_id = &qserver_id;
  args.offset = &offset;
  args.len = &len;
  args.write(oprot_);
...
void SuccinctServiceClient::recv_fetch(std::string& _return)
{
  ...
  SuccinctService_fetch_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void SuccinctServiceProcessor::process_fetch(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("SuccinctService.fetch", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "SuccinctService.fetch");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "SuccinctService.fetch");
  }

  SuccinctService_fetch_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "SuccinctService.fetch", bytes);
  }

  SuccinctService_fetch_result result;
  try {
    iface_->fetch(result.success, args.qserver_id, args.offset, args.len);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "SuccinctService.fetch");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "SuccinctService.fetch");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "SuccinctService.fetch", bytes);
  }
}
