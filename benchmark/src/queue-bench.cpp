...
void print_usage(char *exec) {
    fprintf(stderr, "Usage: %s [-c test-config-file] [-o output-path] [-p num_partitions]\n", exec);
}
...
int main(int argc, char **argv) {
    ...
    DynamicAdaptBenchmark q_bench(configfile, reqpath, respath, addpath, delpath, skew, num_partitions);
