...
service AdaptiveSuccinctService {
    ...
    i32 connect_to_local_servers(1:i32 client_id),
    i32 disconnect_from_local_servers(1:i32 client_id),

    i32 start_servers(),
    i32 initialize(1:i32 mode),

    i32 get_request(1:i32 client_id, 2:i64 key),
    i64 get_request_local(1:i32 client_id, 2:i32 local_shard_id, 3:i64 key),
    string get_response(1:i32 client_id, 2:i32 replica_id),
    string get_response_local(1:i32 client_id, 2:i32 local_shard_id),
